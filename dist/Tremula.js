(function() {
    ...
    define('Easings', [], function() {
        ...
        function easeInQuint_t(t) {
            return t * t * t * t * t
        };
        // decelerating to zero velocity
        function easeOutQuint_t(t) {
            return 1 + (--t) * t * t * t * t
        };
    ...
    define('DataAdapters', [
        ...
        function TremulaItem(data) {
            this.data = data;
            this.imgUrl = data.imageURL; //optional
    ...
    define('Projections', [], function() {
        ...
        function turntable(x, y) {
            ...
            this.e.style.transform = this.e.style.OTransform = this.e.style.MozTransform = this.e.style.webkitTransform =
                'translate3d(' + xo + 'px,' + yo + 'px, ' + zo + 'px)' + ' rotateY(' + ((tRamp * 180) - 90) + 'deg)';
        ...
        function enterTheDragon(x, y) {
            ...
            this.e.style.transform = this.e.style.OTransform = this.e.style.MozTransform = this.e.style.webkitTransform =
                'translate3d(' + xo + 'px,' + yo + 'px, ' + zo + 'px)' + ' rotateY(' + ((hRamp * 180) - 90) + 'deg)'
            // +' scale('+(tri*2)+')';
    ...
    define('Box', [
        ...
        var Box = function(grid) {
            ...
            this.ezEnabled = function() {
                return this.parent.itemEasing;
            }
            this.ezOptions = this.parent.options.itemEasingParams;
            this.doPreloading = this.parent.options.itemPreloading;
            this.getlayoutXansEasing = function() {
                return this.parent.layoutXansEasing;
            }
            this.getLayoutIsXing = function() {
                return this.parent.layoutIsXing;
            }
            this.getLayoutXingMs = function() {
                return this.parent.layoutXansMs;
            }
            ...
            this.ani_si = new Animator({
                easingCurve: easings.easeOutCubic,
                parent: this
            });
            this.ani_si_ = new Animator({
                easingCurve: easings.easeOutCubic,
                parent: this
            });
            ...
            this.setModel = function(obj) {
                ...
                if (obj.isFavorite) {
                    this.$e.addClass('isFavorite');
                } else {
                    this.$e.removeClass('isFavorite');
                }
        ...
        Box.prototype.doOnScreen = function(torf) {
            if (torf != undefined && this.isOnScreen !== torf) {
                ...
                var c = this.e.classList,
                    d = this.e.style.display;
                if (torf) {
                    if (!this.hasEntered) {
        ...
        Box.prototype.setAbsPos = function(x, y) {
            ...
            var
                ...
                isSynchThreshTrig = (
                    axisArg > this.targetXY[si] + synchThresh || axisArg < this.targetXY[si] - synchThresh || trThresh
                ) ? 1 : 0,

                isSynchThreshTrig_ = (
                    axisArg_ > this.targetXY[si_] + synchThresh || axisArg_ < this.targetXY[si_] - synchThresh || trThresh
                ) ? 1 : 0;
            ...
            if (
                (axisArg != this.targetXY[si] && isSynchThreshTrig) || (axisArg_ != this.targetXY[si_] && isSynchThreshTrig_)
            ) {
    ...
    define('Grid', [
        ...
        var Grid = function($target, options, parent) {
                ...
                this.trackFrameRate = function() {
                    ...
                    sum = this.frameRateLog.reduce(function(memo, val) {
                        return memo + val
                    })
        ...
        Grid.prototype.setLastTouchOrigin = function(evt) {
            ...
            return {
                saEventPos: sa,
                saEventPosProgress: saEventPosProgress
            };
        ...
        Grid.prototype.startPhysicsLoop = function() {
            ...
            if (!this.physicsLoopRAF) {
                var that = this;
                this.physicsLoopRAF = requestAnimationFrame(function() {
                    that.assignBoxObjects()
                });
            }
        }
        ...
        Grid.prototype.initBoxes = function(data, adapter, flag) {
            try {
                ...
                return console && console.log('initBoxes(): No data found.');
            };
            ...
            var hasLcbInBoxesArray = this.boxes.filter(function(x) {
                return x.model.isLastContentBlock
            }).length > 0;
        ...
        Grid.prototype.setLayout = function(layout, options) {
            ...
            if (!layout && (!this.lastLayoutOptions || !this.lastLayoutOptions.layout)) {
                return
            };
            if (!options && (!this.lastLayoutOptions || !this.lastLayoutOptions.options)) {
                return
            };
		...
		*/
        ...
        Grid.prototype.assignBoxObjects = function() {
            ...
            for (var i = 0; i < this.boxCount; i++) {
                ...
                //set DOM position
                if (
                    isInViewport.call(this, b) && (this.isLooping || isOnFirstPage.call(this, b))
                ) {
                    b.doOnScreen(true);
                    b.setWaveforms({
                        tailRamp: tailRamp,
    ...
    requirejs.config({
        baseUrl: 'src'
    }); //use this config line when building with almond.js
    ...
    define('Tremula', [
        'Layouts'
        // ,'SurfaceMaps'
        , 'Easings', 'DataAdapters', 'Projections', 'Grid'
    ], function(
        layouts
        // ,surfaceMaps
        , easings, dataAdapters, projections, Grid
        ...
        var Tremula = function() {
            ...
            this.updateConfig = function() {
                console && console.error && console.error('Tremula is not initalized. Request ignored.')
            };
            this.toggleScrollAxis = function() {
                console && console.error && console.error('Tremula is not initalized. Request ignored.')
            };
        }
        ...
        Tremula.prototype.init = function($e, options, parent) {
            ...
            if (!gridOptions.ignoreUserEvents) { //setup event listening unless we want to ignoreUserEvents
                ...
                var fanEvents = new Hammer($e[0], {
                    prevent_default: false
                });
                fanEvents.on('dragdown dragup dragleft dragright swipeleft swipeup swipedown swiperight touch release tap', function(evt) {
        ...
        function imageLoaded(e) {
            ...
            $e.addClass('loaded');
            setTimeout(function() {
                $e.parents('.gridBox').addClass('loaded')
            }, 1500); //this is a little ape-y but whatever. see Box.prototype.doOnScreen() method for some context.
        }
