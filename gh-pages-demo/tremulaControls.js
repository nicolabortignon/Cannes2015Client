function attachDemoControls(tremula) {
    ...
    $(".streamHorizontal").click(function() {
        ...
        setTimeout(function() {
            ...
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                axes: 0,
                itemConstraint: targetSize,
                itemMargins: [25, 25],
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic, tremula.projections.streamHorizontal);
            resizeFn(tremula)
        }, 100)
    })
    ...
    $(".btnL2").click(function() {
        ...
        setTimeout(function() {
            ...
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                itemConstraint: targetSize,
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic, tremula.projections.turntable);
    ...
    $(".btnL3").click(function() {
        ...
        setTimeout(function() {
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                itemMargins: [30, 30],
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic, tremula.projections.enterTheDragon);
            s.setItemEasing(false);
            resizeFn(tremula)
        }, 100)
    })
    ...
    $(".btnL4").click(function() {
        ...
        setTimeout(function() {
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                itemConstraint: 100,
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic, tremula.projections.sunrise);
            s.setItemEasing(false);
            resizeFn(tremula)
        }, 100)
    })
    ...
    $(".mountain").click(function() {
        ...
        setTimeout(function() {
            ...
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                itemMargins: [10, 10],
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic, tremula.projections.mountain);
            s.setItemEasing(false);
            diableAuto();
            refreshData = false;
            resizeFn(tremula)
    ...
    $(".btnL5").click(function() {
        ...
        setTimeout(function() {
            ...
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                itemMargins: [5, 5],
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic, tremula.projections.bezierShape);
            s.setItemEasing(false);
            resizeFn(tremula)
        }, 100)
    })
    ...
    $(".btn1").click(function() {
        ...
        setTimeout(function() {
            s.doTransition(tremula.layouts.basicGridLayout, {
                ...
                axes: 0,
                staticAxisOffset: 0
            }, 800, tremula.easings.easeOutElastic);
            s.setItemEasing(false);
            diableAuto();
        }, 100)
    })
    ...
    function resizeSteppedScrolling(t) {
        ...
        g.updateConfig({
            scrollAxisOffset: newScrollOffset
        }, true);
        t.resize();
    ...
    $(".loadArtDotCom").click(function() {
        loadArtDotCom(null, postLoadSeq)
    });
    $(".loadFlickr").click(function() {
        loadFlickr(null, postLoadSeq)
    })



    function loadArtDotCom(url_, cb) {
        var dataUrl = 'http://146.148.2.249:3000/artworks/galleries/2';

        // var dataUrl = 'decorProductSearch.json';
        $.getJSON(dataUrl, function(res) {


            var rs = res; //filter out any with a really wide aspect ratio.
            console.log("---")
            console.log(rs)
            console.log("---")
            if (refreshData) {
                console.log('refresh', rs);
                tremula.refreshData(rs, tremula.dataAdapters.TremulaItem); //art.com
                if (cb) cb();
            } else {
                console.log('append', rs);
                tremula.appendData(rs, tremula.dataAdapters.TremulaItem); //art.com
                if (cb) cb();
            }
        }).fail(function() {
            console.log('getJSON problem.')
        });
    }
    ...
    function loadFlickr(url_, cb) {
        ...
        $.ajax({
            ...
            .done(function(res) {
                console.log(res);
                var rs = res.photos.photo.filter(function(o, i) {
    ...
    window.loadHorizontalStepped = function loadHorizontalStepped() {
        ...
        tremula.Grid.updateConfig({
            steppedScrolling: true,
            axes: 0,
            itemConstraint: 200,
            itemMargins: [20, 20],
            easeToCompensation: 0,
            surfaceMap: horizontalStepped
        });
        window.resizeFn = resizeSteppedScrolling;
        window.resizeFn(tremula)
        loadArtDotCom(null, postLoadSeq)
    ...
    window.loadMountainPop = function() {
        ...
        tremula.Grid.updateConfig({
            ...
            itemConstraint: 150,
            itemMargins: [20, 20],
            easeToCompensation: -15,
            surfaceMap: mountainPop
        });
        window.resizeFn = resizeSteppedScrolling;
        window.resizeFn(tremula)
        loadArtDotCom(null, postLoadSeq)
    ...
    window.loadTwelveToSix = function() {
        ...
        tremula.Grid.updateConfig({
            ...
            itemConstraint: 100,
            itemMargins: [10, 10],
            easeToCompensation: 50,
            surfaceMap: twelveToSix
        });
        window.resizeFn = resizeSteppedScrolling;
        window.resizeFn(tremula)
        loadArtDotCom(null, postLoadSeq)
